        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-xl">
            ...
            <div className="space-y-5">
              <div>
                <p className="text-white/40 text-sm mb-1">Entity Name</p>
              ...
              <div>
                <p className="text-white/40 text-sm mb-1">Life Stage</p>
          ...
          <div className="bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-xl">
            ...
            <div className="space-y-5">
              ...
              <div>
                <p className="text-white/40 text-sm mb-1">Subscription</p>
